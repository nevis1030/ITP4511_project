...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2025 at 09:00 AM
...
CREATE TABLE `stocklevel` (
  ...
  `warehouse_id` varchar(4) DEFAULT NULL,
  `quantity` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('s001f001', 'f001', 's001', NULL, 20),
('s002f001', 'f001', 's002', NULL, 10),
('s003f002', 'f002', 's003', NULL, 10),
('s004f002', 'f002', 's004', NULL, 15),
('s005f003', 'f003', 's005', NULL, 20),
('s006f003', 'f003', 's006', NULL, 15),
('w001f001', 'f001', NULL, 'w001', 100),
('w002f002', 'f002', NULL, 'w002', 150),
...
('u003', NULL, 'w001', 'HK warehouse staff 1', 'hkwhs1', 'hkwhs1', 1),
...
('u011', NULL, 'w007', 'Japan warehouse staff 1', 'jpwhs1', 'jpwhs1', 1),
...
('w001', 'c001', 'Hong Kong central warehouse 1'),
...
('w007', 'c007', 'Japan central warehouse 1'),
